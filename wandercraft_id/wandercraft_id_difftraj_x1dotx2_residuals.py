...
from wandercraft_id_NN_models import MLPn, WDC_simple_recog4, \
    WDC_single_deformation_model, WDC_x1dotx2_resmodel
...
# Imposing x1dot = x2 and learning the residuals of the prior linear model
...
if __name__ == '__main__':
    ...
    if train:
        ...
        f = MLPn(num_hl=5, n_in=config.n + nu_submodel, n_hl=100, n_out=2,
                 activation=nn.SiLU())
        submodel = WDC_x1dotx2_resmodel(f, config)
