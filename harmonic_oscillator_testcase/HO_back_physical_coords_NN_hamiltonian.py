...
# The system is known to be Hamiltonian: we directly approximate the
# Hamiltonian with a NN, and train it so that the observed trajectories
# follow corresponding Hamiltonian dynamics
